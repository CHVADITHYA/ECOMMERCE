...
const Product = () => {
  ...
  return productData ? (
    <div className='opacity-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='mt-20'>
        ...
        <div className='flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500'>
          <p>An e-commerce website is an online platform that facilitates the buying and selling of products or services over the internet. It serves as a virtual marketplace where businesses and individuals con showcase their products, interact with customers, ond conduct transactions without the nood for a physical presence. E-commerce websites have gained immense popularity due to their convenience, occessibility, and the global reach they offer.</p>
          <p>E-commerce websites typically daplay products or services along with detailed descriptions, images, prices, and any available variations (e.g., sires, colors). Each product usually has its own dedicoted page with relevant information </p>
        </div>
      </div>
